...
- `WeatherTool`, `CalculatorTool`, and `SearchTool` are deterministic tools for local verification.
...
curl http://127.0.0.1:8787/demo/transcript
curl -X POST http://127.0.0.1:8787/agents/demo/run -d '{"message":"calculate 2+3 and search D1"}'
```
