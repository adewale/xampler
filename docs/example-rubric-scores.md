...
| `r2-01` | R2 object storage | 8.75 | Most mature example: dataclasses, typed options, streaming, multipart `async with`, iteration, `.raw` escape hatch. Needs object handle API and route tests. |

## Overall average

**8.1 / 10** across the current set.
