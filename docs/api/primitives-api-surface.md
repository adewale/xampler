...
| R2 Data Catalog | `examples/storage-data/r2-data-catalog` | 6.8 | 8.3 | `R2DataCatalog`, `DemoR2DataCatalog`, `Namespace`, `TableRef`; list namespaces/tables via Iceberg REST API and fixture verifier. | PyIceberg client example, table creation, append/read, schema evolution, snapshots. |
